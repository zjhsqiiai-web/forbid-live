...
class ForbidToken(discord.Client):
    ...
    async def on_message(self, message):
        # 🔥 THE CHEAT CODE: Tricks your old code into working perfectly
        client = self  
        
        # Pull in the global dictionaries so your old code can see them
        global gcnc_tasks
        global spam_tasks
        ...
        if message.author.id != MAIN_OWNER and message.author.id not in AUTHORIZED_USERS: return
